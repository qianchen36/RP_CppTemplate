...
#define PWM_CH3_Pin GPIO_PIN_9
#define PWM_CH3_GPIO_Port GPIOE
#define BMI_ACC_INT_Pin GPIO_PIN_10
#define BMI_ACC_INT_GPIO_Port GPIOE
#define BMI_ACC_INT_EXTI_IRQn EXTI15_10_IRQn
...
#define PWM_CH4_Pin GPIO_PIN_13
